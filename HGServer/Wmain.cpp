...
bool InitInstance(HINSTANCE hInstance, int nCmdShow) {
  ...
  GetLocalTime(&SysTime);
  // 50Cent - Ordenado executed time
  wsprintf(
      cTitle,
      "Helbreath GameServer V%s.%s %d (Executed: %02d:%02d - %02d/%02d/%d)",
      DEF_UPPERVERSION, DEF_LOWERVERSION, DEF_BUILDDATE, SysTime.wHour,
      SysTime.wMinute, SysTime.wDay, SysTime.wMonth, SysTime.wYear);
